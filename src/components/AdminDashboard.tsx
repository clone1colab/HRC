        ...
        <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-2xl mb-6 flex items-start gap-3 shadow-sm animate-fade-in">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-emerald-700 leading-relaxed">
              Hệ thống đồng bộ dữ liệu thời gian thực đang hoạt động ổn định trên đám mây. Tất cả Cộng tác viên (CTV) và Quản trị viên (Admin) sẽ nhận thông tin cập nhật, chốt đơn và tính hoa hồng tức thì trên mọi thiết bị!
            </p>
          </div>
        </div>
